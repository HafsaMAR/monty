...
/*{"push", &push}, {"pall", &pall}, {"pop", &pop}, {"pint", &pint}, {"swap", &swap}, {"nop", &nop}, {"add", &add}, {"sub", sub}, {"div", &division}, {"mul", &mul}, {"rotl", &rotl}, {"rotr", &rotr}, {"stack", &stack}, {"queue", &queue}, {"pstr", &pstr}, {"pchar", &pchar}, {"mod", &mod}, {NULL, NULL}};*/
void (*get_operation(char *operation_code))(stack_t **stack, unsigned int line_number)
{
	int i;
	instruction_t operations[] = {
		{"push", &push}, {"pall", &pall}, {"stack", &stack}, {"queue", &queue}, {NULL, NULL}};
